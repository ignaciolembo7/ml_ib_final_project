...
def train(models, data, params):
    ...
    for i in range(train_steps):
        ...
        output_discriminator = discriminator.train_on_batch([x, labels], y)
        loss, acc = output_discriminator[0], output_discriminator[1]
        print("discriminator output", output_discriminator)
        ...
        output_adversarial = adversarial.train_on_batch([noise, fake_labels], y)
        print("adversarial output", output_adversarial)
        loss, acc = output_adversarial[0], output_adversarial[2]
    ...
    generator.save("cgan_mnist.keras")
...
if __name__ == '__main__':
    ...
    if args.generator:
        ...
        optimizer = RMSprop(learning_rate=0.0002)  # Ajusta el learning_rate según lo que usaste
